...
class MainWindow:
    ...
    def _build_layout(self) -> None:
        ...
        # Nav canvas
        nav_canvas = tk.Canvas(self._sidebar, bg=Theme.SIDEBAR_BG, highlightthickness=0)
        ...
        self._nav_canvas_win = nav_canvas.create_window((0, 0), window=self._nav_frame, anchor="nw")
        def _resize(e):
            nav_canvas.itemconfig(self._nav_canvas_win, width=e.width)
        nav_canvas.bind("<Configure>", _resize)
    ...
    def _toggle_theme(self) -> None:
        ...
        for btn in self._nav_btns:
            btn._base_bg = Theme.SIDEBAR_BG
            btn._hover_bg = Theme.SIDEBAR_HOVER
            btn._active_bg = Theme.SIDEBAR_ACTIVE
            btn._active_fg = Theme.SIDEBAR_TEXT_ACTIVE
            btn.configure(bg=Theme.SIDEBAR_ACTIVE if btn._active else Theme.SIDEBAR_BG,
                          fg=Theme.SIDEBAR_TEXT_ACTIVE if btn._active else Theme.SIDEBAR_TEXT)
